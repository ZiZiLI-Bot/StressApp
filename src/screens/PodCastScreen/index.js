...
const podcastHighlights = [
  {
    ...
    link: require('../../../assets/mp3/Podcast6.mp3'),
    owner: 'Wingman',
    image:
  ...
  },
  {
    ...
    link: require('../../../assets/mp3/Podcast7.mp3'),
    owner: 'Hieu Nguyen',
    image:
  ...
  },
  {
    ...
    link: require('../../../assets/mp3/Podcast8.mp3'),
...
const podcastList = [
  {
    ...
    link: require('../../../assets/mp3/Podcast1.mp3'),
    owner: 'Hieu Nguyen',
    image:
  ...
  },
  {
    ...
    link: require('../../../assets/mp3/Podcast2.mp3'),
  ...
  },
  {
    ...
    link: require('../../../assets/mp3/Podcast3.mp3'),
    owner: 'Dan Foolish',
    image:
  ...
  },
  {
    ...
    link: require('../../../assets/mp3/Podcast4.mp3'),
    owner: 'Vietcetera',
  ...
  },
  {
    ...
    link: require('../../../assets/mp3/Podcast5.mp3'),
...
export default function PodCastScreen({navigation}) {
  ...
  const playSound = uri => {
    const whoosh = new Sound(uri, error => {
      if (error) {
